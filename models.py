...
from boggleBoard import getBoggleBoard
...
class Game(ndb.Model):
    ...
    all_solutions = ndb.PickleProperty(required=True)

    # boggle is played by rounds
    # score should be a global feature
    ...
    def new_game(cls, user_x, user_o):
        ...
        game = Game(user_x=user_x,
                    user_o=user_o,
                    next_move=user_x)
        game.board, game.all_solutions = getBoggleBoard()
    ...
    def to_form(self):
        ...
        form = GameForm(urlsafe_key=self.key.urlsafe(),
                        ...
                        all_solutions = str(self.all_solutions),
...
class GameForm(messages.Message):
    ...
    all_solutions = messages.StringField(6, required=True)
