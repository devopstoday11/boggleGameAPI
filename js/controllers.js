...
/**
 * The root boggleApp module.
 *
 * @type {boggleApp|*|{}}
 */
var boggleApp = boggleApp || {};
 ...
 *
 */
boggleApp.controllers = angular.module('conferenceControllers', ['ui.bootstrap']);
 ...
 */
boggleApp.controllers.controller('MyProfileCtrl',
 ...
 */
boggleApp.controllers.controller('CreateConferenceCtrl',
    function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
 ...
 */
boggleApp.controllers.controller('ShowConferenceCtrl', function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
 ...
 */
boggleApp.controllers.controller('ConferenceDetailCtrl', function ($scope, $log, $routeParams, HTTP_ERRORS) {
    $scope.conference = {};
 ...
 *
 */
boggleApp.controllers.controller('RootCtrl', function ($scope, $location, oauth2Provider) {
 ...
 *
 */
boggleApp.controllers.controller('OAuth2LoginModalCtrl',
 ...
 */
boggleApp.controllers.controller('DatepickerCtrl', function ($scope) {
