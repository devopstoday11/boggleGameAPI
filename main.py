...
class SendReminderEmail(webapp2.RequestHandler):
    def get(self):
        ...
        for user in users:
            # TODO: remind only players who have not made a move in 12 hours
...
class UpdateAverageMovesRemaining(webapp2.RequestHandler):
    def post(self):
        ...
        boggleGameAPI._cache_average_attempts()
...
class SendMoveEmail(webapp2.RequestHandler):
    def post(self):
        ...
        body = '{}, It\'s your turn to play Boggle. The game key is: {}'.\
